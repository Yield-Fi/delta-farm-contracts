  ...
  IWorkerConfig
{
  ...
  function initialize(IPriceOracle _oracle) external initializer {
    __Ownable_init();
  ...
  function isStable(address worker) public view override returns (bool) {
    ...
    require(lastUpdate >= block.timestamp - 1 days, "WorkerConfig::isStable:: price too stale");

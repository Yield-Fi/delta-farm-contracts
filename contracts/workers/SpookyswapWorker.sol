...
import "../libs/spookyswap/farm/interfaces/ISpookySwapMasterChef.sol";
...
contract SpookySwapWorker is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IWorker {
  /// @notice Libraries
  ...
  ISpookySwapMasterChef public masterChef;
  ...
  function initialize(
    ...
    address _baseToken,
    ISpookySwapMasterChef _masterChef,

...
contract SpookySwapStrategyAddToPoolWithoutBaseToken is
  Initializable,
  OwnableUpgradeSafe,
  ...
  IAddStrategy
{
  ...
  function execute(bytes calldata data) external override nonReentrant returns(uint256) {
    ...
    IUniswapV2Pair T0_T1_LP = IUniswapV2Pair(factory.getPair(token0, token1));
